...
기본자세:
    ...
    MOVE G6D,100,  83, 145,  86, 99, 100
    MOVE G6B,100,  28,  80, 	, 100, 100
...
왼쪽턴45:
    ...
    GOSUB Leg_motor_mode2
    SPEED 8
    MOVE G6A,96,  107, 177,  19, 105, 100
    MOVE G6D,96,  35,  135,  138, 105, 100
    MOVE G6B,120
    MOVE G6C,80
    WAIT
    ...
    SPEED 10
    MOVE G6A,94,  107, 177,  19, 105, 100
    MOVE G6D,94,  35,  135,  138, 105, 100
    MOVE G6B,120
    MOVE G6C,80
    WAIT
...
MAIN:
    ...
    ON A GOTO MAIN,KEY1,KEY2,KEY3,KEY4,KEY5,KEY6,KEY7,KEY8,KEY9,KEY10,KEY11,KEY12,KEY13,KEY14,KEY15,KEY16,KEY17,KEY18,KEY19,KEY20,KEY21
    'GOTO KEY34
    'DELAY 500
