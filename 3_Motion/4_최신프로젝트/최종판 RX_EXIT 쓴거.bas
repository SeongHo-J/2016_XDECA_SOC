...
기본자세4:
    ...
    MOVE G6D,100,  84, 137,  94, 100, 100
    MOVE G6B,100,  30,  80, 	, 100, 100
    MOVE G6C,100 ,  32,  80, 100, 170, 100
    WAIT
...
안정화자세2:
    ...
    MOVE G6D,99,  75, 145,  93, 101, 100
    MOVE G6B,100,  25,  80, 100, 100, 100
    MOVE G6C,102,  31,  80, 100, 155, 100
    WAIT
    RETURN
...
왼쪽옆으로20:
    ...
    SPEED 12
    MOVE G6A, 93,  90, 120, 107, 104, 100
    MOVE G6D,103,  76, 145,  95, 104, 100
    WAIT

    SPEED 12
    MOVE G6A, 102,  77, 145, 95, 100, 100
    MOVE G6D,90,  80, 140,  97, 107, 100
    WAIT
...
오른쪽옆으로20:
    ...
    SPEED 12
    MOVE G6D, 93,  90, 120, 107, 104, 100
    MOVE G6A,103,  76, 145,  95, 104, 100
    WAIT

    SPEED 12
    MOVE G6D, 102,  77, 145, 95, 100, 100
    MOVE G6A,90,  80, 140,  97, 107, 100
    WAIT
...
MAIN:
    ...
    ON A GOTO MAIN,KEY1,KEY2,KEY3,KEY4,KEY5,KEY6,KEY7,KEY8,KEY9,KEY10,KEY11,KEY12,KEY13,KEY14,KEY15,KEY16,KEY17,KEY18,KEY19,KEY20,KEY21,KEY22,KEY23,KEY24,KEY25,KEY26,KEY27,KEY28,KEY29,KEY30
    'GOTO KEY34
    'DELAY 500
